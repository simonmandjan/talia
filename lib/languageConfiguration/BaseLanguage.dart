...
class BaseLanguage {
  ...
  String get payoutReports => getContentValueFromKey(508);
  String get weeklyEarningsOverview => getContentValueFromKey(509);
  String get totalPayout => getContentValueFromKey(510);
  String get totalPendingPayout => getContentValueFromKey(511);
  String get lblAll => getContentValueFromKey(512);
  String get processing => getContentValueFromKey(513);
  String get noMoreRecords => getContentValueFromKey(514);
  String get noPayoutRecordsFound => getContentValueFromKey(515);
  String get pullDownToRefresh => getContentValueFromKey(516);
  String get failedToLoadPayouts => getContentValueFromKey(517);
  String get commission => getContentValueFromKey(518);
  String get payoutAmount => getContentValueFromKey(519);
  String get viewDocument => getContentValueFromKey(520);
  String get generated => getContentValueFromKey(521);
  String get payoutReport => getContentValueFromKey(522);
  String get waitingForPaymentConfirmationOnPhone => getContentValueFromKey(523);
  String get paymentStillProcessing => getContentValueFromKey(524);
  String get country => getContentValueFromKey(525);
  String get mobileMoneyOperator => getContentValueFromKey(526);
  String get otpCode => getContentValueFromKey(527);
  String get dialPrefix => getContentValueFromKey(528);
  String get dialSuffix => getContentValueFromKey(529);
  String get paymentSuccessWalletUpdateFailed => getContentValueFromKey(530);
  String get paymentFailedInvalidToken => getContentValueFromKey(531);
  String get externalWallet => getContentValueFromKey(532);
  String get paymentCanceled => getContentValueFromKey(533);
  String get driverPayoutReportDocument => getContentValueFromKey(534);
  String get invoiceDownloadedAt => getContentValueFromKey(535);
  String get failedToDownloadPdf => getContentValueFromKey(536);
  String get allowStoragePermission => getContentValueFromKey(537);
  String get errorWhileDownloadingPdf => getContentValueFromKey(538);
  String get unableToCompleteRideCheckGps => getContentValueFromKey(539);
  String get day => getContentValueFromKey(540);
  String get days => getContentValueFromKey(541);
  String get hr => getContentValueFromKey(542);
  String get remaining => getContentValueFromKey(543);
  String get canUpdateRideStatusOnlyOnScheduledTime => getContentValueFromKey(544);
  String get somethingWrong => getContentValueFromKey(545);
  String get shareDes1 => getContentValueFromKey(546);
  String get shareDes2 => getContentValueFromKey(547);
  String get shareDes3 => getContentValueFromKey(548);
  String get copiedToClipboard => getContentValueFromKey(549);
  String get yourReward => getContentValueFromKey(550);
  String get scratchAndWin => getContentValueFromKey(551);
  String get revealYourExclusiveReward => getContentValueFromKey(552);
  String get oops => getContentValueFromKey(553);
  String get betterLuck => getContentValueFromKey(554);
  String get nextTime => getContentValueFromKey(555);
  String get coinsWon => getContentValueFromKey(556);
  String get percentMoreToGo => getContentValueFromKey(557);
  String get claimReward => getContentValueFromKey(558);
  String get scratchToReveal => getContentValueFromKey(559);
  String get pleaseScratchCoupon => getContentValueFromKey(560);
  String get coinWallet => getContentValueFromKey(561);
  String get totalCoins => getContentValueFromKey(562);
  String get coins => getContentValueFromKey(563);
  String get coinsEarned => getContentValueFromKey(564);
  String get coinsRedeemed => getContentValueFromKey(565);
  String get useCoins => getContentValueFromKey(566);
  String get availableCoins => getContentValueFromKey(567);
  String get maxUsable => getContentValueFromKey(568);
  String get enterCoinsToUse => getContentValueFromKey(569);
  String get enterCoins => getContentValueFromKey(570);
  String get quickSelect => getContentValueFromKey(571);
  String get lblMax => getContentValueFromKey(572);
  String get rideAmount => getContentValueFromKey(573);
  String get coinDiscount => getContentValueFromKey(574);
  String get finalAmount => getContentValueFromKey(575);
  String get apply => getContentValueFromKey(576);
  String get coinsApplied => getContentValueFromKey(577);
  String get saveAmount => getContentValueFromKey(578);
  String get youHave => getContentValueFromKey(579);
  String get coinsAvailable => getContentValueFromKey(580);
  String get dontHaveAnyCoins => getContentValueFromKey(581);
  String get removeExistingCoins => getContentValueFromKey(582);
  String get selectTimeAtLeast15Min => getContentValueFromKey(583);
  String get enterValidScheduleTime => getContentValueFromKey(584);
  String get fetchingAddress => getContentValueFromKey(585);
  String get locationServicesDisabled => getContentValueFromKey(586);
  String get permissionPermanentlyDenied => getContentValueFromKey(587);
  String get errorFetchingAddress => getContentValueFromKey(588);
  String get searchForAPlace => getContentValueFromKey(589);
  String get locationRequestTimedOut => getContentValueFromKey(590);
  String get unableToFetchLocation => getContentValueFromKey(591);
  String get pleaseSelectFutureTime => getContentValueFromKey(592);
  String get pleaseProvideFlightNumber => getContentValueFromKey(593);
  String get pleaseProvidePickupTime => getContentValueFromKey(594);
  String get signUpToGetStarted => getContentValueFromKey(595);
  String get becomeADriver => getContentValueFromKey(596);
  String get mightyCoinHistory => getContentValueFromKey(597);
  String get pleaseFirstSelectSourceLocation => getContentValueFromKey(598);
  String get pleaseSelectLocation => getContentValueFromKey(599);

  String get or => getContentValueFromKey(371);
